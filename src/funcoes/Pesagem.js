...
export const pesagem= (pokemon, climate) => {
    ...
    switch(true){
        ...
        case climate.humidity>50 && climate.humidity<=70:
            ...
            prioridade=verify_type(pokemon, prioridade,  "grass", 0.1);
            break;
    ...
    switch(true){
        case climate.cloudcover<=20:
            ...
            break;
        case climate.cloudcover>20 && climate.cloudcover<=50:
            if((hora>0 && hora<6) || (hora=>18 && hora<=23)){
                prioridade=verify_type(pokemon, prioridade,  "dark", 0.3);
                prioridade=verify_type(pokemon, prioridade,  "ghost", 0.2);
            }
            else{
                prioridade= verify_type(pokemon, prioridade, "psychic", 0.3);
            }
            break;
        case climate.cloudcover>50 && climate.cloudcover<=70:
            if((hora>0 && hora<6) || (hora=>18 && hora<=23)){
                prioridade= verify_type(pokemon, prioridade, "dark", 0.2);
                prioridade= verify_type(pokemon, prioridade, "ghost", 0.4);
            }
            else{
                prioridade=verify_type(pokemon, prioridade,  "psychic", 0.4);
            }
        case climate.cloudcover>70:
            if((hora>0 && hora<6) || (hora=>18 && hora<=23)){
